...
let obj2 = { b: '222', a: 'foo' }
let newObj = Object.assign(obj1, obj2)
console.log(newObj === obj1) // true (obj1 is modified)
console.log(newObj === obj2) // false
// Later object properties override earlier object properties
```

### _.merge (lodash utility library)
...
|--------|----------------|
| Spread Operator | Returns a new object, shallow copy, later properties override earlier ones |
| Object.assign | Modifies and returns the first object, shallow copy |
| _.merge | Deep merge, recursively merges objects and arrays |

Reference: [lodash merge](https://www.lodashjs.com/docs/lodash.merge)
<!-- /en -->